...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('test',function (){
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://api.zoom.us/v2/users/hJ3YF4HSRLSj75ZXPCJO9g/meetings",
            ...
            CURLOPT_HTTPHEADER => array(
                "authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOm51bGwsImlzcyI6InpVdjhnRE9SUm5XRDNLaWxPamFZeHciLCJleHAiOjE1OTU4NjEwMjYsImlhdCI6MTU5NTI1NjIyNn0.KLDiIdJpHOnp1zthfwpg-L4FESYXPiYes0E_HcyEte0",
