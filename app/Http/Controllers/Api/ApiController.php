...
class ApiController extends Controller
{
    ...
    public function coursesList(Request $request){
        ...
        if($purchases->isEmpty()){
            ...
            foreach($courses as $course){
                $parts = ContentPart::where('content_id', $course->id)->whereBetween('initial_date', [$weekStartDate, $weekEndDate])->select(['id as part_id', 'title as part_title', 'initial_date', 'limit_date', 'content_id', 'zoom_meeting', 'date as zoom_date', 'time as zoom_time', 'upload_video as video', 'mode'])->get();
