        ...
        <div class="product-discount-container">
            <div class="col-md-4 col-xs-12 tab-con">
                <div class="container-s-r">
                    <strong class="red-r"><?php if($product->discount->last_date - time() > 86400): ?>
                        <?php echo e((floor(($product->discount->last_date - time()) / (60 * 60 * 24)))); ?> <?php else: ?> 0 <?php endif; ?></strong>
    ...
    <div class="col-xs-12 col-md-12">
        <div class="product-discount-container">
            <div class="col-md-4 col-xs-12">
                <div class="container-s-r">
                    <strong class="red-r"><?php if($product->category->discount->last_date - time() > 86400): ?>
                        <?php echo e((floor(($product->category->discount->last_date - time()) / (60 * 60 * 24)))+1); ?> <?php else: ?> 0
                        <?php endif; ?> Day</strong>
                    <strong><?php echo e(trans('main.days')); ?></strong>
                    <strong><?php echo e(trans('main.special_offer')); ?></strong>
                </div>
            </div>
        ...
        <div class="container">
            <div class="col-md-4 col-xs-12 course_details">
                <div class="product-details-box">
                    ...
                    <span class="pn-category"><?php echo e($product->category->title); ?></span>
                </div>

                <div class="product-details-box">
                    <span class="proicon mdi mdi-alarm"></span>
                    <span><?php echo e(convertToHoursMins($Duration,'%01d hour %02d min')); ?></span>
                </div>
                <div class="product-details-box">
                    <span
                        class="proicon mdi mdi-calendar-month"></span><span><?php echo e(date('d F Y',$product->created_at)); ?></span>
                </div>
                <div class="product-details-box">
                ...
                <div class="product-price-box">
                    ...
                    <span
                        id="buy-price"><?php echo e(currencySign()); ?><?php echo e(price($product->id,$product->category_id,$meta['price'])['price']); ?></span>
                    <?php else: ?>
                    ...
                    <form>
                        ...
                        <div class="radio">
                            <input type="radio" id="radio-2" name="buy_mode" data-mode="download"
                                value="<?php echo e(price($product->id,$product->category_id,$meta['price'])['price']); ?>" checked>
                        ...
                        <?php if(!empty($product->price) and $product->price != 0): ?>
                        <div class="radio">
                            <input type="radio" id="radio-1" data-mode="post"
                                value="<?php echo e(price($product->id,$product->category_id,$meta['post_price'])['price']); ?>"
                                name="buy_mode">
                        ...
                        <?php if(!empty($product->price) and $product->price != 0): ?>
                        <a class="btn btn-orange product-btn-buy sbox3" id="buy-btn" data-toggle="modal"
                            data-target="#buyModal" href=""><?php echo e(trans('main.pay')); ?></a>
                        <?php endif; ?>
                        <?php else: ?>
                        <?php if(!empty($product->price) and $product->price != 0): ?>
                        <a class="btn btn-orange product-btn-buy sbox3"
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                            ...
                            <div id="postAddress">
                                <form method="post" class="form-horizontal" action="/user/profile/meta/store">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="control-label col-md-1 tab-con"><?php echo e(trans('main.province')); ?></label>
                                        <div class="col-md-5 tab-con">
                                            <input type="text" class="form-control" name="state"
                                                value="<?php echo $userMeta['state'] ?? ''; ?>" />
                                        </div>
                                        <label class="control-label col-md-1 tab-con"><?php echo e(trans('main.city')); ?></label>
                                        <div class="col-md-5 tab-con">
                                            <input type="text" name="city" value="<?php echo e($userMeta['city'] ?? ''); ?>"
                                                class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="control-label col-md-1 tab-con"><?php echo e(trans('main.address')); ?></label>
                                        <div class="col-md-5 tab-con">
                                            <textarea name="address" rows="4"
                                                class="form-control"><?php echo e($userMeta['address'] ?? ''); ?></textarea>
                                        </div>
                                        <label
                                            class="control-label col-md-1 tab-con"><?php echo e(trans('main.zip_code')); ?></label>
                                        <div class="col-md-5 tab-con">
                                            <input type="text" name="postalcode"
                                                value="<?php echo e($userMeta['postalcode'] ?? ''); ?>"
                                                class="form-control text-center">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <input type="submit" name="submit" class="btn btn-orange pull-left"
                                                value="Save">
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="javascript:void(0);" class="btn btn-custom pull-right" id="btn-address"
                                onclick="$('#postAddress').slideToggle(200);"><?php echo e(trans('main.change_address')); ?></a>
                ...
                <div class="row">
                    ...
                    <div class="course_details">
                        <div class="product-user-box text-left">
                            <h4 class="text-left">
                                ...
                                <span style="text-align: left !important;"><?php echo trans('main.live_class_info'); ?></span>
                            </h4>
                            <div class="h-10"></div>
                            <span style="text-align: left !important;margin: 0;">
                                <i class="proicon mdi mdi-calendar"></i>
                                <?php echo $live->date; ?>&nbsp;<?php echo $live->time ?? ''; ?>

                            </span>
                            <span style="text-align: left !important;margin: 0;">
                                <i class="proicon mdi mdi-clock"></i>
                                <?php echo $live->duration; ?>&nbsp;<?php echo trans('admin.minutes'); ?>

                            </span>
                            <?php if($live->password != null && $live->password != ''): ?>
                            <span style="text-align: left !important;margin: 0;">
                                <i class="proicon mdi mdi-key"></i>
                                <?php echo $live->password; ?>
                        ...
                        <div class="product-user-box-footer">
                            <a href="<?php echo $live->join_url ?? ''; ?>"
                                target="_blank"><?php echo e(trans('main.enter_live_class')); ?></a>
                        </div>
                        <div class="h-25"></div>
                    </div>
                    <div class="h-10"></div>
                    ...
                    <div class="course_details">
                        <div class="product-user-box">
                            ...
                            <img class="img-box"
                                src="<?php echo e(!empty($userMetas['avatar']) ? $userMetas['avatar'] : get_option('default_user_avatar','')); ?>"
                            ...
                            <div class="text-center">
                                ...
                                <img class="img-icon img-icon-s" src="<?php echo e($rate['image']); ?>"
                                    title="<?php echo e($rate['description']); ?>" />
                                <?php endif; ?>
            ...
            <div class="col-md-8 col-xs-12 product-part-container">
                <div class="user-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="#tab1" role="tab"
                                data-toggle="tab"><?php echo e(trans('main.course_content')); ?></a></li>
                        <?php if($product->type == 'webinar' || $product->type == 'course+webinar'): ?>
                        <li><a href="#tab6" role="tab" data-toggle="tab"><?php echo e(trans('main.meeting')); ?></a></li>
                        <?php endif; ?>
                        <li><a href="#tab2" role="tab" data-toggle="tab"><?php echo e(trans('main.details')); ?></a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <ul class="part-ul">
                                    ...
                                    <div class="part-links">
                                        ...
                                        <div class="col-md-1 col-xs-2 tab-con">
                                            <span class="download-part"
                                                data-href="/video/download/<?php echo e($part['id']); ?>"><span
                                ...
                                <li class="document">
                                    ...
                                    <div class="col-md-1 text-center">
                                        <span class="download-part" data-href="<?php echo e($meta['document']); ?>"><span
                                                class="mdi mdi-arrow-down-bold"></span></span>
                                    </div>
                                </li>
                                <?php endif; ?>
                        ...
                        <div class="tab-pane fade in tab-body" id="tab3">
                            ...
                            <div class="col-md-4 col-xs-12 tab-con">
                                <a href="/product/<?php echo e($pc->id); ?>" title="<?php echo e($pc->title); ?>"
                                    class="content-box content-box-r">
                                    <img src="<?php echo e($pmeta['thumbnail']); ?>" />
                                    <h3><?php echo truncate($pc->title,25); ?></h3>
                                    <div class="footer">
                                        <span class="boxicon mdi mdi-wallet pull-left"></span>
                                        <label
                                            class="pull-left"><?php echo e(currencySign()); ?><?php echo e(price($pc->id,$pc->category_id,$pmeta['price'])['price']); ?></label>
                                    </div>
                                </a>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="tab-pane fade" id="tab4">
                            ...
                            <ul class="part-ul">
                                ...
                                <li class="row">
                                    ...
                                    <div class="col-md-2 text-center hidden-xs tab-con">
                                        <span
                                            style="color: <?php echo e($quiz->result_status == 'pass' ? 'green' : ($quiz->result_status == 'fail' ? 'red' : 'black')); ?>"><?php echo e(( isset($quiz->user_grade)) ? $quiz->user_grade : 'No grade'); ?></span>
                                    </div>

                                    <div class="col-md-2 text-center hidden-xs tab-con">
                                        <a href="<?php echo e(($quiz->can_try) ? '/user/quizzes/'. $quiz->id .'/start' : ''); ?>"
                                            <?php echo e((!$quiz->can_try) ? 'disabled="disabled"' : ''); ?>

                                            class="btn btn-success btn-round">quizzes</a>
                                    </div>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        ...
                        <div class="tab-pane fade" id="tab5">
                            <?php if(!empty($product->quizzes) and !$product->quizzes->isEmpty() and $hasCertificate and
                            ...
                            <ul class="part-ul">
                                ...
                                <li class="row">
                                    ...
                                    <div class="col-md-2 text-center hidden-xs tab-con">
                                        <a href="/user/certificates/<?php echo e($quiz->result->id); ?>/download"
                                            class="btn btn-success"><?php echo e(trans('main.download_certificate')); ?></a>
                                    </div>
                                </li>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="user-tabs">
                    <ul class="nav nav-tabs back-blue" role="tablist">
                        <li class="active"><a href="#vtab1" role="tab"
                                data-toggle="tab"><?php echo e(trans('main.similar_courses')); ?></a></li>
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane fade in tab-body" id="vtab1">
                            ...
                            <div class="col-md-4 col-xs-12 tab-con">
                                <a href="/product/<?php echo e($rel->id); ?>" title="<?php echo e($rel->title); ?>"
                                    class="content-box content-box-r">
                                    ...
                                    <div class="footer">
                                        <span class="boxicon mdi mdi-wallet pull-left"></span>
                                        <label
                                            class="pull-left"><?php echo e(currencySign()); ?><?php echo e(price($rel->id,$rel->category_id,$rmeta['price'])['price']); ?></label>
                                    </div>
                                </a>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="tab-pane fade tab-body" id="vtab2">
                            ...
                            <div class="col-md-4 col-xs-12 tab-con">
                                <a href="/product/<?php echo e($puc->id); ?>" title="<?php echo e($puc->title); ?>"
                                    class="content-box content-box-r">
                                    ...
                                    <div class="footer">
                                        <span class="boxicon mdi mdi-wallet pull-left"></span>
                                        <label
                                            class="pull-left"><?php echo e(currencySign()); ?><?php echo e(price($puc->id,$puc->category_id,$umeta['price'])['price']); ?></label>
                                    </div>
                                </a>
                            </div>
                            <?php endif; ?>
                ...
                <div class="user-tabs">
                    <ul class="nav nav-tabs back-green" role="tablist">
                        <li class="active"><a href="#ctab1" role="tab"
                                data-toggle="tab"><?php echo e(trans('main.comments')); ?>&nbsp;(<?php echo e($product->comments_count); ?>)</a>
                        </li>
                        <?php if($product->support == 1): ?>
                        <?php if(!empty($product->supports->sum('rate')) and $product->supports->sum('rate') > 0 and
                        !empty($product->supports) and count($product->supports) > 0): ?>
                        <li><a href="#ctab2" role="tab" data-toggle="tab">Support &nbsp;(Rating:
                                <?php echo e($product->support_rate); ?>)</a></li>
                        <?php else: ?>
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane fade in blog-comment-section body-target-s" id="ctab1">
                            ...
                            <ul class="comment-box support-list1">
                                ...
                                <li class="user-metas">
                                    <img src="<?php echo e($userMeta['avatar'] ?? '/assets/default/images/user.png'); ?>" alt="" />
                                    <a href="/profile/<?php echo e($comment->user_id); ?>"><?php echo e($comment->name); ?>

                                        <?php if($comment->user->buys_count > 0): ?> <b
                                            class="green-s">(<?php echo e(trans('main.student')); ?>)</b>
                                        <?php elseif($comment->user->contents_count > 0): ?> <b
                                            class="blue-s">(<?php echo e(trans('main.vendor')); ?>)</b> <?php else: ?> <b
                                            class="gray-s">(<?php echo e(trans('main.user')); ?>)</b> <?php endif; ?></a>
                                    <label class="pull-left"><?php echo e(date('d F Y | H:i',$comment->created_at)); ?></label>
                                    <span><?php echo $comment->comment; ?></span>
                                    <?php if($buy or (isset($user) and $product->user_id == $user['id'])): ?><span><a
                                            href="javascript:void(0);" answer-id="<?php echo e($comment->id); ?>"
                                            answer-title="<?php echo e($comment->name); ?>"
                                            class="pull-left answer-btn"><?php echo e(trans('main.reply')); ?></a> </span><?php endif; ?>
                                </li>
                                ...
                                <ul class="col-md-11 col-md-offset-1 answer-comment">
                                    ...
                                    <li>
                                        <img src="<?php echo e(!empty($cuserMeta['avatar']) ? $cuserMeta['avatar'] : '/assets/default/images/user.png'); ?>"
                                            alt="" />
                                        <a href="/profile/<?php echo e($child->user_id); ?>"><?php echo e($child->name); ?>

                                            <?php if($child->user->buys_count > 0): ?> <b
                                                class="green-s">(<?php echo e(trans('main.customer')); ?>)</b>
                                            <?php elseif($child->user->contents_count > 0): ?> <b
                                                class="blue-s">(<?php echo e(trans('main.vendor')); ?>)</b> <?php else: ?> <b
                                                class="gray-s">(<?php echo e(trans('main.user')); ?>)</b> <?php endif; ?></a>
                                ...
                                <span class="btn btn-custom pull-left"
                                    id="loadMore1"><?php echo e(trans('main.load_more')); ?></span>
                                <?php endif; ?>
                            </ul>
                        </div>
                        <?php if($product->support == 1): ?>
                        <div class="tab-pane fade blog-comment-section body-target-s" id="ctab2">
                            ...
                            <div class="col-xs-12 text-center support-lock">
                                ...
                                <a
                                    href="/user/ticket/support?openid=<?php echo e($product->id); ?>"><?php echo e(trans('main.panel_support')); ?></a>
                            ...
                            <ul class="comment-box support-list">
                                ...
                                <li class="user-metas">
                                    <img src="<?php echo e(!empty($senderMeta['avatar']) ? $senderMeta['avatar'] : '/assets/default/images/user.png'); ?>"
                                        alt="" />
                                ...
                                <li class="user-metas">
                                    ...
                                    <label class="pull-left text-center">
                                        ...
                                        <br>
                                        <div class="userraty urating" data-score="<?php echo e($support->rate); ?>"
                                            data-id="<?php echo e($support->id); ?>"></div>
                                    </label>
                                    <span><?php echo $support->comment; ?></span>
                                </li>
                                <?php endif; ?>
                                ...
                                <span class="btn btn-custom pull-left"
                                    id="loadMore"><?php echo e(trans('main.load_more')); ?></span>
                                <?php endif; ?>
                            </ul>
                        </div>
                        <?php endif; ?>
...
<div class="modal fade" id="cardModal" tabindex="-1" role="dialog" aria-labelledby="cardModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cardModalLabel">Credit/Debit card pay</h5>
            </div>
            <div class="modal-body">
                <h2>There was an error with your card, verify the info.</h2>
            </div>
            <div class="modal-footer">
                <a href="/product/<?php echo e($product->id); ?>"><button type="button" class="btn btn-secondary">Close</button></a>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        fluidPlayer("myDiv", {
            layoutControls: {
                posterImage: '<?php echo !empty($meta['
                cover ']) ? $meta['
                cover '] : '
                '; ?>',
                logo: {
                    imageUrl: '<?php echo get_option('
                    video_watermark ','
                    '); ?>', // Default null
            ...
            vastOptions: {
                vastTimeout: {
                    !!get_option('site_videoads_time', 5) * 1000!!
                },
                adList: [{
                    roll: '<?php echo get_option('
                    site_videoads_roll_type ','
                    preRoll '); ?>',
                    vastTag: '<?php echo get_option('
                    site_videoads_source '); ?>',
                    adText: '<?php echo get_option('
                    site_videoads_title '); ?>',
                }]
            }
            <?php endif; ?>
...
<script>
    $('.raty').raty({
        ...
        score: {
            {
                ($product->rates->avg('rate')) ? $product->rates->avg('rate'): 0
            }
        },
        click: function (rate) {
        ...
        if (code == '') {
            ...
            $.get('/gift/' + code, function (data) {
                if (data == 0) {
                    ...
                    if (data.type == 'gift')
                        $('#gift-card-result').html(
                            '<b class="green-s"> Congratulations! <?php echo currencySign(); ?>' + data.off +
                            ' Discount applied successfully!</b>');
                    if (data.type == 'off')
                        $('#gift-card-result').html('<b class="green-s"> Congratulations! %' + data
                            .off + ' Discount applied successfully!</b>');
                }
            })
        }
    });
    ...
    $('.buy-mode').on('change', function () {
        if ($(this).is(':checked')) {
            ...
            $('.btn-subscribe').each(function () {
                let url = '/product/subscribe/' + $(this).attr('p-id') + '/' + $(this).attr('s-type') +
                    '/' + buyMode;
                $(this).attr('href', url);
            });
        }
