                ...
                <div class="col-md-9 col-xs-12 col-sm-8 tab-con left-side">
                    ...
                    <div class="steps dnone" id="step2">
                        <form method="post" id="step-2-form" class="form-horizontal">
                            ...
                            <div class="h-15"></div>
                            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-11 col-md-offset-1 tab-con filters dnone" <?php if($menu->id != $item->category_id): ?> class="dnone" <?php endif; ?> id="filter<?php echo e($menu->id); ?>">
...
<?php echo $__env->make(getTemplate().'.user.layout.sendvideolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy\resources\views/web/default/user/content/edit.blade.php ENDPATH**/ ?>