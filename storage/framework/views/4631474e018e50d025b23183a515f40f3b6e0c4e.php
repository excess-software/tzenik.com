...
<?php $__env->startSection('page'); ?>
    ...
    <?php if($product['discount'] != null): ?>
            ...
            <div class="col-xs-12 col-md-12">
                <div class="product-discount-container">
                    ...
                    <div class="col-md-2 col-xs-12 tab-con">
                        <div class="row">
                            <span class="off-btn">
                                <label>%<?php echo e($product->discount->off or 0); ?></label>
        ...
        <div class="h-20"></div>
    <?php elseif($product->category->discount != null): ?>
        <div class="container">
            <div class="col-xs-12 col-md-12">
                <div class="product-discount-container">
                    ...
                    <div class="col-md-2 col-xs-12">
                        <div class="row">
                            <span class="off-btn">
                                <label>%<?php echo e($product->category->discount->off or 0); ?></label>
                                <label><?php echo e(trans('main.discount')); ?></label>
                            </span>
                        </div>
                    </div>
        ...
        <div class="row product-body">
            <div class="container">
                <div class="col-md-4 col-xs-12 course_details">
                    ...
                    <div class="product-details-box">
                        <span class="proicon mdi mdi-alarm"></span><span><?php echo e(convertToHoursMins($meta['duration'],'%01d hour %02d min')); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="product-details-box">
                        <span class="proicon mdi mdi-calendar-month"></span><span><?php echo e(date('d F Y',$product->create_at)); ?></span>
                    </div>
                    <div class="product-details-box">
                    ...
                    <div class="product-details-box">
                        ...
                        <span>
                            <?php if($meeting_data): ?>
                            <?php $__currentLoopData = $meeting_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <b><?php echo e(trans('main.meeting_date')); ?></b> <?php echo e(date('d-m-Y', strtotime($meeting->date))); ?> <?php echo e($meeting->time); ?>

                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                            <b><?php echo e(trans('main.meeting_date')); ?></b> <?php echo e($meeting_date); ?>
                    ...
                    <div class="product-price-box">
                        ...
                        <?php if($meta['price'] == '0' || $product->price == 0): ?>
                            <span  id="buy-price"><?php echo e(trans('main.free')); ?></span>
                        <?php else: ?>
                            <span  id="buy-price"><?php echo e(currencySign()); ?><?php echo e(price($product->id,$product->category_id,$meta['price'])['price']); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="h-10"></div>
                    <div class="product-buy-selection">
                        <form>
                            <?php if(isset($user) && $product->user_id == $user['id']): ?>
                                <a class="btn btn-orange product-btn-buy sbox3" id="buy-btn" href="/user/content/edit/<?php echo e($product->id or 0); ?>"><?php echo e(trans('main.edit_course')); ?></a>
                                <a class="btn btn-blue product-btn-buy sbox3" id="buy-btn" href="/user/content/part/list/<?php echo e($product->id or 0); ?>"><?php echo e(trans('main.add_video')); ?></a>
                            <?php else: ?>
                                <?php if(!$buy): ?>
                                    <?php if($product->price != 0 && $meta['price'] != '0'): ?>
                                        <div class="radio">
                                    ...
                                    <?php if($product->price != 0 && $meta['price'] != '0'): ?><a class="btn btn-orange product-btn-buy sbox3" id="buy-btn" data-toggle="modal" data-target="#buyModal" href=""><?php echo e(trans('main.pay')); ?></a><?php endif; ?>
                                <?php else: ?>
                                    <?php if($product->price != 0 && $meta['price'] != '0'): ?><a class="btn btn-orange product-btn-buy sbox3" href="javascript:void(0);"><?php echo e(trans('main.purchased_item')); ?></a><?php endif; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="radio">
                                    ...
                                    &nbsp;
                                    <label class="radio-label" for="mode-1"><?php echo e(trans('main.account_charge')); ?>&nbsp;<b id="credit-remain-modal">(<?php echo e(currencySign()); ?><?php echo e($user['credit'] or 0); ?>)</b></label>
                                </div>
                                ...
                                <div class="table-responsive table-base-price">
                                    <table class="table table-hover table-factor-modal">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center"><?php echo e($meta['price'] or 0); ?></td>
                                ...
                                <div class="table-responsive table-post-price table-post-price-s">
                                    <table class="table table-hover table-factor-modal" style="margin-bottom: 0;padding-bottom: 0;">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center"><?php echo e($meta['post_price'] or 0); ?></td>
                            ...
                            <div class="modal-body">
                                ...
                                <?php if(isset($user)): ?>
                                    <div id="modal-user-category">
                                        ...
                                        <b><?php echo e($user['category']['off'] or 0); ?>٪</b>
                ...
                <div class="col-md-8 col-xs-12">
                    <iframe style="height: 600px; width: 100%;" src="https://zoom.us/wc/<?php echo e($meeting->zoom_meeting ?? $meeting); ?>/join?prefer=0&un=TWluZGF1Z2Fz" sandbox="allow-forms allow-scripts allow-same-origin" allow="microphone; camera" allowfullscreen scrolling="no"></iframe>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container">
                <div class="col-md-4 col-xs-12 course_details">
                    ...
                    <div class="product-user-box">
                        ...
                        <img class="img-box" src="<?php echo e($userM['avatar'] or get_option('default_user_avatar','')); ?>" class="img-responsive"/>
                        	<h3>
                        ...
                        <?php if(isset($ads)): ?>
                            <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($ad->position == 'product-page'): ?>
                                    <a href="<?php echo e($ad->url or '#'); ?>"><img src="<?php echo e($ad->image ?? ''); ?>" class="<?php echo e($ad->size ?? ''); ?>" id="ppage-s"></a>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-md-8 col-xs-12 product-part-container">
                                    ...
                                    <?php $__currentLoopData = $parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="part-links">
                                                <a href="/product/part/<?php echo e($product->id or 0); ?>/<?php echo e($part['id']); ?>">
                                        ...
                                        <div class="col-md-2 tab-con">
                                            <span class="btn btn-gray btn-description hidden-xs" data-toggle="modal" href="#description-<?php echo e($part['id'] or 0); ?>"><?php echo e(trans('main.description')); ?></span>
                                            <div class="modal fade" id="description-<?php echo e($part['id'] or 0); ?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                        ...
                                        <div class="col-md-2 text-center hidden-xs tab-con">
                                            <span><?php echo e($part['size'] or '0'); ?> <?php echo e(trans('main.mb')); ?></span>
                                        </div>
                                        <div class="col-md-2 hidden-xs tab-con">
                                            <span><?php echo e($part['duration'] or 0); ?> <?php echo e(trans('main.minute')); ?></span>
                                        </div>
                                        <?php if($product->download == 1): ?>
                                            <div class="col-md-1 col-xs-2 tab-con">
                                                <span class="download-part" data-href="/video/download/<?php echo e($part['id'] or '0'); ?>"><span class="mdi mdi-arrow-down-bold"></span></span>
                                            </div>
                                        <?php endif; ?>
                                        </div>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($meta['document']) && $meta['document']!=''): ?>
                                        <li class="document">
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-1 text-center">
                                                <a href="<?php echo e($meta['document'] ?? ''); ?>"><span class="download-part" data-href=""><span class="mdi mdi-arrow-down-bold"></span></span></a>
                                            </div>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <?php $__currentLoopData = $precourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4 col-xs-12 tab-con">
                                        <a href="/product/<?php echo e($pc->id ?? ''); ?>" title="<?php echo e($pc->title ?? ''); ?>" class="content-box content-box-r">
                                            ...
                                            <h3><?php echo Str::limit($pc->title,25,'...'); ?></h3>
                                            <div class="footer">
                                ...
                                <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4 col-xs-12 tab-con">
                                        <a href="/product/<?php echo e($rel->id ?? ''); ?>" title="<?php echo e($rel->title ?? ''); ?>" class="content-box content-box-r">
											...
											<h3><?php echo Str::limit($rel->title,25,'...'); ?></h3>
                                            <div class="footer">
												<span class="boxicon mdi mdi-wallet pull-left"></span>
                                ...
                                <?php $__currentLoopData = $product->user->contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4 col-xs-12 tab-con">
                                        <a href="/product/<?php echo e($puc->id ?? ''); ?>" title="<?php echo e($puc->title ?? ''); ?>" class="content-box content-box-r">
											...
											<h3><?php echo Str::limit($puc->title,25,'...'); ?></h3>
                                            <div class="footer">
												<span class="boxicon mdi mdi-wallet pull-left"></span>
                    ...
                    <div class="user-tabs">
                        <ul class="nav nav-tabs back-green" role="tablist">
                            <li class="active"><a href="#ctab1" role="tab" data-toggle="tab"><?php echo e(trans('main.comments')); ?>&nbsp;(<?php echo e($product->comments_count or 0); ?>)</a></li>
                            ...
                            <?php if($product->supports->sum('rate')!=null && $product->supports->sum('rate')>0 && $product->supports!=null && count($product->supports)>0): ?>
                                <li><a href="#ctab2" role="tab" data-toggle="tab">Support &nbsp;(Rating: <?php echo e($product->support_rate or 0); ?>)</a></li>
                            <?php else: ?>
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane fade in blog-comment-section body-target-s" id="ctab1">
                                <?php if(isset($user)): ?>
                                    <form method="post" action="/product/comment/store/<?php echo e($product->id or 0); ?>">
                                ...
                                <ul class="comment-box support-list1">
                                    <?php $__currentLoopData = $product->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($comment->parent == 0): ?>
                                            ...
                                            <li class="user-metas">
                                                <img src="<?php echo e($usermeta['avatar'] or '/assets/images/user.png'); ?>" alt=""/>
                                                ...
                                                <?php if(count($comment->childs)>0): ?>
                                                    <ul class="col-md-11 col-md-offset-1 answer-comment">
                                                        <?php $__currentLoopData = $comment->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <li>
                                                                <img src="<?php echo e($cusermeta['avatar'] or '/assets/images/user.png'); ?>" alt=""/>
                            ...
                            <?php if($product->support == 1): ?>
                                <div class="tab-pane fade blog-comment-section body-target-s" id="ctab2">
                                    <?php if($buy || $product->price == 0 || $meta['price'] == '0'): ?>
                                    ...
                                    <?php elseif(isset($user) && $product->user_id == $user['id']): ?>
                                        <div class="col-xs-12 text-center support-lock">
                                            ...
                                            <a href="/user/ticket/support?openid=<?php echo e($product->id or 0); ?>"><?php echo e(trans('main.panel_support')); ?></a>
                                ...
                                <ul class="comment-box support-list">
                                    <?php $__currentLoopData = $product->supports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(isset($user) && $support->sender_id == $user['id']): ?>
                                            <?php if($support->supporter_id != $support->user_id): ?>
                                                <?php $senderMeta = arrayToList($support->sender->usermetas,'option','value'); ?>
                                                <li class="user-metas">
                                                    <img src="<?php echo e($senderMeta['avatar'] or '/assets/images/user.png'); ?>" alt=""/>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <li class="user-metas">
                                                    ...
                                                    <label class="pull-left text-center">
                                                        ...
                                                        <br>
                                                        <div class="userraty urating" data-score="<?php echo e($support->rate or 0); ?>" data-id="<?php echo e($support->id or 0); ?>"></div>
                                                    </label>
                                                    <span><?php echo $support->comment ?? ''; ?></span>
                                                </li>
                                            <?php endif; ?>
