                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="list-group">
                            <a href="/user/dashboard/all" style="text-decoration: none;">
                                <li class="list-group-item list-content-media list-active"><b>Todos los cursos</b></li>
                            </a>
                            <br>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 dash-content-user">
                                <a href="/product/<?php echo e($item->content->id); ?>" title="<?php echo e($item->content->title); ?>"
                                    class="enlace-tabs">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(getTemplate().'.view.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/web/default/user/dashboard/all.blade.php ENDPATH**/ ?>