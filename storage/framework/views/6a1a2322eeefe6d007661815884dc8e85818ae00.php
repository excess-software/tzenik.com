...
<?php $__env->startSection('page'); ?>
    <section class="card card-collapsed">
        <div class="card-body">
            <p><?php echo e(trans('admin.student')); ?> : [student] </p>
            <hr>
            <p><?php echo e(trans('admin.course')); ?> : [course] </p>
            <hr>
            <p><?php echo e(trans('admin.mark')); ?> : [mark] </p>
        </div>
    </section>
...
unset($__errorArgs, $__bag); ?></div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control hauto text-left  <?php $__errorArgs = ['body'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" dir="ltr" rows="6" name="body"><?php echo e((!empty($template)) ? $template->body :''); ?></textarea>
                ...
                <div class="col-12">
                    <div class="custom-switches-stacked">
                        <label class="custom-switch">
                            ...
                            <label class="custom-switch-description" for="inputDefault"><?php echo e(trans('admin.status')); ?></label>
                        </label>
                    </div>
                    <div class="h-15"></div>
                </div>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Email Template']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/admin/certificates/create_template.blade.php ENDPATH**/ ?>