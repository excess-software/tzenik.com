...
<?php $__env->startSection('page'); ?>
    ...
    <section class="card">
        <div class="card-body">
            <form action="/admin/discount/content/edit/store/<?php echo e($discount->id); ?>" class="form-horizontal form-bordered" method="post">
                    ...
                    <div class="col-md-8">
                        <select name="off_id_content" class="form-control populate" id="type">
                            <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($content->id); ?>" <?php if($discount->off_id == $content->id): ?> selected <?php endif; ?> ><?php echo e($content->title); ?></option>
                    ...
                    <div class="col-md-8">
                        <select name="off_id_category" class="form-control populate" id="type">
                            <?php $__currentLoopData = $categoreis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>" <?php if($discount->off_id == $category->id): ?> selected <?php endif; ?>><?php echo e($category->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="date" id="fsdate" value="<?php echo e(date('Y-m-d',$discount->first_date) ?? ''); ?>" class="text-center form-control" name="fdate" placeholder="Start Date">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="date" id="lsdate" class="text-center form-control" value="<?php echo e(date('Y-m-d',$discount->last_date)); ?>" name="ldate" placeholder="End Date">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <input type="number" min="0" max="99" name="off" value="<?php echo e($discount->off); ?>" class="form-control text-center" placeholder="Percent only (Eg: 20 for 20%)" required>
                            </div>
                        </div>
                        <div class="col-md-4">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Promotions','Edit']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gardoon1/domains/academybusiness.ir/next/resources/views/admin/discount/contentedit.blade.php ENDPATH**/ ?>