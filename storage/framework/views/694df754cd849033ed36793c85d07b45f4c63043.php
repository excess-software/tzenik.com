                ...
                <div class="col-md-9 col-xs-12 col-sm-8 tab-con left-side">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <select name="type" class="form-control font-s">
                                        <option value="single" <?php if(isset($item) && $item->type == 'single'): ?> selected <?php endif; ?>><?php echo e(trans('main.single')); ?></option>
                                        <option value="course" <?php if(isset($item) && $item->type == 'course'): ?> selected <?php endif; ?>><?php echo e(trans('main.course')); ?></option>
                                        <option value="webinar" <?php if(isset($item) && $item->type == 'webinar'): ?> selected <?php endif; ?>><?php echo e(trans('main.webinar')); ?></option>
                                        <option value="course+webinar" <?php if(isset($item) && $item->type == 'course+webinar'): ?> selected <?php endif; ?>><?php echo e(trans('main.course+webinar')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="steps dnone" id="step2">
                        <form method="post" id="step-2-form" class="form-horizontal">
                            ...
                            <div class="h-15"></div>
                            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-11 col-md-offset-1 tab-con filters <?php if($menu->id != $item->category_id): ?> dnone <?php endif; ?>" id="filter<?php echo e($menu->id ?? 0); ?>">
                                            ...
                                            <ul class="cat-filters-li pamaz">
                                                <ul class="submenu submenu-s">
                                                    <?php $__currentLoopData = $filter->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="second-input"><input type="checkbox" class="filter-tags dblock" id="tag<?php echo e($tag->id); ?>" name="filters[]" value="<?php echo e($tag->id); ?>" <?php if(isset($item->filters) && in_array($tag->id,$item->filters->pluck('id')->toArray())): ?> checked <?php endif; ?>><label for="tag<?php echo e($tag->id); ?>"><span></span><?php echo e($tag->tag); ?></label></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                            </ul>
                                        </div>
                                        ...
                                        <ul class="pre-course-title-container">
                                            <?php if(isset($preCourse)): ?>
                                                <?php $__currentLoopData = $preCourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><?php echo e($prec->title); ?>&nbsp;(VT-<?php echo e($prec->id); ?>)<i class="fa fa-times delete-course" cid="<?php echo e($prec->id); ?>"></i></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="cover" class="form-control"  dir="ltr" type="text" name="cover" value="<?php echo e(!empty($meta['cover']) ? $meta['cover'] : ''); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="thumbnail" class="form-control"  dir="ltr" type="text" name="thumbnail" value="<?php echo e(!empty($meta['thumbnail']) ? $meta['thumbnail'] : ''); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="video" class="form-control" dir="ltr" type="text" name="video" value="<?php echo e(!empty($meta['video']) ? $meta['video'] : ''); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="document" class="form-control" dir="ltr" type="text" name="document" value="<?php echo e(!empty($meta['document']) ? $meta['document'] : ''); ?>">
                                    ...
                                    <div class="submenu dblock">
                                        ...
                                        <form action="/user/content/part/edit/store/" id="step-5-form-edit-part" method="post" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="control-label tab-con col-md-2"><?php echo e(trans('main.video_file')); ?></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="control-label col-md-1 tab-con"><?php echo e(trans('main.duration')); ?></label>
                                                <div class="col-md-3 tab-con">
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2 tab-con">
                                                    <button class="btn btn-custom pull-left" id="edit-part-submit" type="submit"><?php echo e(trans('main.edit_part')); ?></button>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="h-15"></div>
...
<?php echo $__env->make(getTemplate().'.user.layout.sendvideolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gardoon1/domains/academybusiness.ir/next/resources/views/web/default/user/content/edit.blade.php ENDPATH**/ ?>