                        ...
                        <table class="table table-bordered table-striped mb-none" id="datatable-details">
                            ...
                            <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e(!empty($list->contents_count) ? $list->contents_count : '0'); ?></td>
                                    <td class="text-center"><?php echo e(!empty($list->filters_count) ? $list->filters_count : '0'); ?></td>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="image" class="form-control" value="<?php echo e($item->image ?? ''); ?>" type="text" name="image" dir="ltr" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="icon" class="form-control" value="<?php echo e($item->icon ?? ''); ?>" type="text" name="icon" dir="ltr" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="background" class="form-control" value="<?php echo e($item->background ?? ''); ?>" type="text" name="background" dir="ltr" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="app_icon" class="form-control" value="<?php echo e($item->app_icon ?? ''); ?>" type="text" name="app_icon" dir="ltr" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="req_icon" class="form-control" value="<?php echo e($item->req_icon ?? ''); ?>" type="text" name="req_icon" dir="ltr" >
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Courses','Categories',$item->title]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gardoon1/domains/academybusiness.ir/next/resources/views/admin/content/categroychild.blade.php ENDPATH**/ ?>