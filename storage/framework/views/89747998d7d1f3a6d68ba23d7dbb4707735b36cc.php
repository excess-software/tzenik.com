            ...
            <div class="tab-content">
                <div id="day" class="tab-pane active">
                    <form method="post" action="/admin/user/rate/store" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="description" value="<?php echo e($item->description ?? ''); ?>" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group" style="display: flex">
                                    ...
                                    <input id="image1" class="form-control" type="text" name="image" value="<?php echo e($item->image ?? ''); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="text" name="price" value="<?php echo e($item->gift ?? ''); ?>" class="form-control text-center numtostr">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="commision" value="<?php echo e($item->commision ?? ''); ?>" placeholder="%" class="form-control text-center">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" value="<?php echo e($item->start ?? ''); ?>" name="start" required>
                                    <span class="input-group-append">
                                        <span class="input-group-text"><?php echo e(trans('admin.to')); ?></span>
                                    </span>
                                    <input type="number" class="form-control" value="<?php echo e($item->end ?? ''); ?>" name="end" required>
                        ...
                        <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($list->mode == 'day'): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e($list->gift); ?></td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group" style="display: flex">
                                    ...
                                    <input id="image2" class="form-control" type="text" name="image" value="<?php echo e($item->image ?? ''); ?>">
                                    <div class="input-group-prepend view-selected cu-p" data-toggle="modal" data-target="#ImageModal" data-whatever="image">
                                        <span class="input-group-text">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group" style="display: flex">
                                    ...
                                    <input id="image3" class="form-control" type="text" name="image" value="<?php echo e($item->image ?? ''); ?>">
                                    <div class="input-group-prepend view-selected cu-p" data-toggle="modal" data-target="#ImageModal" data-whatever="image">
                                        <span class="input-group-text">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group" style="display: flex">
                                    ...
                                    <input id="image4" class="form-control" type="text" name="image" value="<?php echo e($item->image ?? ''); ?>">
                                    <div class="input-group-prepend view-selected cu-p" data-toggle="modal" data-target="#ImageModal" data-whatever="image">
                                        <span class="input-group-text">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group" style="display: flex">
                                    ...
                                    <input id="image5" class="form-control" type="text" name="image" value="<?php echo e($item->image ?? ''); ?>">
                                    <div class="input-group-prepend view-selected cu-p" data-toggle="modal" data-target="#ImageModal" data-whatever="image">
                                        <span class="input-group-text">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group" style="display: flex">
                                    ...
                                    <input id="image6" class="form-control" type="text" name="image" value="<?php echo e($item->image ?? ''); ?>">
                                    <div class="input-group-prepend view-selected cu-p" data-toggle="modal" data-target="#ImageModal" data-whatever="image">
                                        <span class="input-group-text">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </span>
                ...
                <div id="postrate" class="tab-pane">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group" style="display: flex">
                                    ...
                                    <input id="image7" class="form-control" type="text" name="image" value="<?php echo e($item->image ?? ''); ?>">
                                    <div class="input-group-prepend view-selected cu-p" data-toggle="modal" data-target="#ImageModal" data-whatever="image">
                                        <span class="input-group-text">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </span>
                    ...
                    <table class="table table-bordered table-striped mb-none" id="datatable-basic">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($list->mode == 'postrate'): ?>
                                <tr>
                                    <td class="text-center">
                                        <img src="<?php echo e($list->image); ?>" width="24"/>
                                    </td>
                                    <td><?php echo e($list->description); ?></td>
                                    <td class="text-center"><?php echo e(str_replace(',',' to ',$list->value)); ?></td>
                                    <td class="text-center"><?php echo e($list->gift); ?></td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Users','Rating','Admin Panel']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gardoon1/domains/academybusiness.ir/next/resources/views/admin/user/rate.blade.php ENDPATH**/ ?>