...
<?php $__env->startSection('page'); ?>
    ...
    <section class="card">
        <div class="card-body">
            ...
            <form action="/admin/forum/post/store" class="form-horizontal form-bordered" method="post">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-10">
                        <select name="category_id" class="form-control select2">
                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id ?? 0); ?>" <?php if(!empty($item->category_id) && $item->category_id == $cat->id): ?> <?php echo e('selected'); ?>  <?php endif; ?>><?php echo e($cat->title); ?></option>
                ...
                <!--<div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input type="text" name="image" value="<?php echo e($item->image ?? ''); ?>" dir="ltr" class="form-control">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Blog','Edit Post']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/admin/forum/edit.blade.php ENDPATH**/ ?>