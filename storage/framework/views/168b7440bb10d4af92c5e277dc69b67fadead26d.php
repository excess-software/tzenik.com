        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="input-group">
                            <input type="date" id="fsdate" value="<?php echo !empty(request()->get('fsdate')) ? request()->get('fsdate') : ''; ?>" class="text-center form-control" name="fsdate" placeholder="Start Date">
                            <input type="hidden" id="fdate" name="fdate" value="<?php echo !empty(request()->get('fdate')) ? request()->get('fdate') : ''; ?>">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input type="date" id="lsdate" value="<?php echo !empty(request()->get('lsdate')) ? request()->get('lsdate') : ''; ?>" class="text-center form-control" name="lsdate" placeholder="End Date">
                            <input type="hidden" id="ldate" name="ldate" value="<?php echo !empty(request()->get('ldate')) ? request()->get('ldate') : ''; ?>">
            ...
            <?php if(count($lists) > 0): ?>
                <div class="alert alert-info">
                    ...
                    <span class="f-w-b" dir="ltr"><?php echo e($alladd); ?></span>
                    <span><?php echo e(trans('admin.cur_dollar')); ?> <?php echo e(trans('admin.and_total_cost_is')); ?></span>
                    <span class="f-w-b color-red-i" dir="ltr"><?php echo e($allminus); ?></span>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php elseif($item->mode == 'user' and !empty($item->exporter)): ?>
                                <span><a href="/admin/user/item/<?php echo e($item->exporter->id); ?>"><?php echo e($item->exporter->name); ?></a></span>
                            <?php endif; ?>
                        </td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Accounting','Financial Analyser']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/admin/balance/analyze.blade.php ENDPATH**/ ?>