<?php $__env->startSection('title'); ?>
    <?php echo e(trans('admin.pending_tickets')); ?>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="input-group">
                            <input type="date" id="fsdate" class="text-center form-control" name="fsdate" value="<?php echo request()->get('fsdate') ?? ''; ?>" placeholder="Start Date">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <input type="date" id="lsdate" class="text-center form-control" name="lsdate" value="<?php echo request()->get('lsdate') ?? ''; ?>" placeholder="End Date">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Support','Pending Tickets']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gardoon1/domains/academybusiness.ir/next/resources/views/admin/ticket/listopen.blade.php ENDPATH**/ ?>