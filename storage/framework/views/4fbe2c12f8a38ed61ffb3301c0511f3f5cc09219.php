                        ...
                        <div class="product-buy-selection">
                            <form>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if($product->meeting_mode == 'active'): ?>
                                        <a class="btn btn-orange product-btn-buy sbox3" href="<?php echo $product->meeting_join_url ?? ''; ?>"><?php echo e(trans('main.enter_live_class')); ?></a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </form>
                        </div>
                            ...
                            <div class="tab-pane fade" id="tab6">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <?php $__currentLoopData = $product->meetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-left"><b><?php echo $meeting->title ?? ''; ?></b></td>
                                            <td class="text-center"><?php echo $meeting->date ?? ''; ?></td>
                                            <td class="text-center"><?php echo $meeting->time ?? ''; ?></td>
...
<?php echo $__env->make(getTemplate().'.view.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\proacademy\resources\views/web/default/view/product/product.blade.php ENDPATH**/ ?>