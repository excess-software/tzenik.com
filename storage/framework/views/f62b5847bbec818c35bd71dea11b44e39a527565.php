        ...
        <div class="col-md-3">
            <ul class="list-group partes-nuevo-curso">
                <li class="list-group-item active" cstep="1"><a href="javascript:void(0);"><span
                            ...
                            <?php echo e(trans('main.general')); ?></span></a>
                </li>
                ...
                <li class="list-group-item" cstep="3"><a href="javascript:void(0);"><span
                            ...
                            <?php echo e(trans('main.extra_info')); ?></span></a>
                </li>
                <li class="list-group-item" cstep="4"><a href="javascript:void(0);"><span
                            class="upicon mdi mdi-folder-image"></span><span> <?php echo e(trans('main.view')); ?></span></a>
                </li>
                <li class="list-group-item" cstep="5"><a href="javascript:void(0);"><span
                            class="upicon mdi mdi-movie-open"></span><span> <?php echo e(trans('main.parts')); ?></span></a>
                </li>
            </ul>
        </div>
        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 tab-con">
                            <select name="type" class="form-control font-s">
                                ...
                                <option value="coaching" <?php if(isset($item) && $item->type == 'coaching'): ?> selected
                                    <?php endif; ?>><?php echo e(trans('main.coaching')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-2 tab-con">
                            <input type="text" name="subs_limit" class="form-control" value="<?php echo e($item->subs_limit ?? ''); ?>"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="steps dnone" id="step2">
                <form method="post" id="step-2-form" class="form-horizontal">
                        ...
                        <div class="col-md-10 tab-con">
                            <select name="category_id" id="category_id" class="form-control font-s" required>
                                ...
                                <optgroup label="<?php echo e($menu->title ?? ''); ?>">
                                    ...
                                    <option value="<?php echo e($sub->id ?? ''); ?>" <?php if($sub->id == $item->category_id): ?>
                                        selected <?php endif; ?>><?php echo e($sub->title ?? ''); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                    <option value="<?php echo e($menu->id ?? ''); ?>" <?php if($menu->id == $item->category_id): ?>
                                        selected <?php endif; ?>><?php echo e($menu->title ?? ''); ?></option>
                                    <?php endif; ?>
                                </optgroup>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="h-15"></div>
                    <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-11 col-md-offset-1 tab-con filters dnone" <?php if($menu->id !=
                        $item->category_id): ?> class="dnone" <?php endif; ?> id="filter<?php echo e($menu->id ?? 0); ?>">
                            ...
                            <ul class="cat-filters-li pamaz">
                                <ul class="submenu submenu-s">
                                    ...
                                    <li class="second-input"><input type="checkbox" class="filter-tags dblock"
                                            id="tag<?php echo e($tag->id ?? ''); ?>" name="filters[]"
                                            value="<?php echo e($tag->id ?? 0); ?>" <?php if(isset($item->filters) &&
                                        in_array($tag->id,$item->filters->pluck('id')->toArray())): ?> checked
                                        <?php endif; ?>><label
                                            for="tag<?php echo e($tag->id ?? ''); ?>"><span></span><?php echo e($tag->tag ?? ''); ?></label>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </ul>
                ...
                <form method="post" id="step-3-form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-5 tab-con col-md-offset-1 dinb" " for="
                            inputDefault"><?php echo e(trans('main.free_course')); ?></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 tab-con">
                            <div class="input-group">
                                ...
                                <span
                                    class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body no-absolute-content">
                                ...
                                <ul class="pre-course-title-container">
                                    ...
                                    <li><?php echo e($prec->title ?? ''); ?>&nbsp;(VT-<?php echo e($prec->id ?? 0); ?>)<i
                                            class="fa fa-times delete-course" cid="<?php echo e($prec->id ?? 0); ?>"></i></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                        ...
                        <div class="col-md-10 tab-con">
                            <div class="input-group">
                                ...
                                <input type="text" name="cover" placeholder="Prefered :410*730px" dir="ltr"
                                    value="<?php echo e($meta['cover'] ?? ''); ?>" class="form-control">
                        ...
                        <div class="col-md-10 tab-con">
                            <div class="input-group">
                                ...
                                <input type="text" name="thumbnail" placeholder="Prefered :155*263px" dir="ltr"
                                    value="<?php echo e($meta['thumbnail'] ?? ''); ?>" class="form-control">
                                <span class="input-group-addon click-for-upload img-icon-s"><span
                                        class="formicon mdi mdi-arrow-up-thick"></span></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-10 tab-con">
                            <div class="input-group">
                                ...
                                <input type="text" name="video" placeholder="Prefered :1-3 mins" dir="ltr"
                                    value="<?php echo e($meta['video'] ?? ''); ?>" class="form-control">
                                <span class="input-group-addon click-for-upload img-icon-s"><span
                                        class="formicon mdi mdi-arrow-up-thick"></span></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-10 tab-con">
                            <div class="input-group document-input">
                                ...
                                <input type="text" name="document" id="document-addon" dir="ltr"
                                    value="<?php echo e($meta['document'] ?? ''); ?>" class="form-control">
            ...
            <div class="row">
                <div class="col-md-12 btn-toolbar">
                    <a href="javascript:void(0);" class="btn btn-custom pull-left tab-con marl-s-10"
                        id="prev-btn"><?php echo e(trans('main.previous')); ?></a>
                    <a href="javascript:void(0);" class="btn btn-custom tab-con pull-left marl-s-10"
                        id="next-btn"><?php echo e(trans('main.next')); ?></a>

                    <?php if($item->mode != 'publish'): ?>
                    <a href="#publish-modal" data-toggle="modal"
                        class="btn btn-custom pull-left tab-con marl-s-10"><?php echo e(trans('main.publish')); ?></a>
                    <?php else: ?>
                    <a href="#re-publish-modal" data-toggle="modal"
                        class="btn btn-custom pull-left tab-con marl-s-10"><?php echo e(trans('main.save_changes')); ?></a>
                    <?php endif; ?>
                    <?php if($item->mode != 'publish'): ?>
