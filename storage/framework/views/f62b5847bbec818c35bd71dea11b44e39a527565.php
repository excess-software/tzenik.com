...
<?php $__env->startSection('pages'); ?>
    ...
    <div class="container-fluid">
        ...
        <input type="hidden" value="<?php echo e($item->id ?? 0); ?>" id="edit_id">
        <div class="container n-padding-xs current-s">
            <div class="h-30"></div>
            <div class="multi-steps">
                <div class="col-md-3 col-xs-12 col-sm-4 tab-con right-side">
                    <ul>
                        <li class="active" cstep="1"><a href="javascript:void(0);"><i class="upicon mdi mdi-library-video"></i><span><?php echo e(trans('main.general')); ?></span></a></li>
                        <li cstep="2"><a href="javascript:void(0);"><i class="upicon mdi mdi-apps"></i><span><?php echo e(trans('main.category')); ?></span></a></li>
                        <li cstep="3"><a href="javascript:void(0);"><i class="upicon mdi mdi-library-books"></i><span><?php echo e(trans('main.extra_info')); ?></span></a></li>
                        <li cstep="4"><a href="javascript:void(0);"><i class="upicon mdi mdi-folder-image"></i><span><?php echo e(trans('main.view')); ?></span></a></li>
                        <li cstep="5"><a href="javascript:void(0);"><i class="upicon mdi mdi-movie-open"></i><span><?php echo e(trans('main.parts')); ?></span></a></li>
                    </ul>
                </div>
                <div class="col-md-9 col-xs-12 col-sm-8 tab-con left-side">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <select name="type" class="form-control font-s">
                                        <option value="webinar" <?php if(isset($item) && $item->type == 'webinar'): ?> selected <?php endif; ?>><?php echo e(trans('main.webinar')); ?></option>
                                        <option value="coaching" <?php if(isset($item) && $item->type == 'coaching'): ?> selected <?php endif; ?>><?php echo e(trans('main.coaching')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <input type="text" name="title" placeholder="Course Title..." class="form-control" value="<?php echo e($item->title ?? ''); ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 tab-con" for="inputDefault"><?php echo e(trans('main.description')); ?></label>
                                <div class="col-md-10 tab-con">
                                    <textarea class="form-control editor-te editor-te-h" placeholder="You can import HTML..." name="content" required><?php echo $item->content ?? ''; ?></textarea>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="steps dnone" id="step2">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label tab-con" for="inputDefault"><?php echo e(trans('main.tags')); ?></label>
                                <div class="col-md-10 tab-con">
                                    <input type="text" data-role="tagsinput" placeholder="Press enter to save tag." name="tag" value="<?php echo e($item->tag ?? ''); ?>" class="form-control text-center">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label tab-con" for="inputDefault"><?php echo e(trans('main.category')); ?></label>
                                <div class="col-md-10 tab-con">
                                    <select name="category_id" id="category_id" class="form-control font-s" required>
                                        <?php if($item->type == 'webinar'): ?>
                                            <option value="35" selected><?php echo e(trans('main.webinar')); ?></option>
                                        <?php elseif($item->type == 'coaching'): ?>
                                            <option value="36" selected><?php echo e(trans('main.coaching')); ?></option>
                                        <?php endif; ?>
                                                ...
                                                <optgroup label="<?php echo e($menu->title ?? ''); ?>">
                                                    <?php if(count($menu->childs)>0): ?>
                                                        <?php $__currentLoopData = $menu->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($sub->id ?? ''); ?>" <?php if($sub->id == $item->category_id): ?> selected <?php endif; ?>><?php echo e($sub->title ?? ''); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php else: ?>
                                                        <option value="<?php echo e($menu->id ?? ''); ?>" <?php if($menu->id == $item->category_id): ?> selected <?php endif; ?>><?php echo e($menu->title ?? ''); ?></option>
                                                    <?php endif; ?>
                                                </optgroup>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="h-15"></div>
                            <div class="alert alert-success"><p><?php echo e(trans('main.filters_header')); ?></p></div>
                            <div class="h-15"></div>
                            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-11 col-md-offset-1 tab-con filters dnone" <?php if($menu->id != $item->category_id): ?> class="dnone" <?php endif; ?> id="filter<?php echo e($menu->id ?? 0); ?>">
                                            ...
                                            <ul class="cat-filters-li pamaz">
                                                <ul class="submenu submenu-s">
                                                    <?php $__currentLoopData = $filter->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="second-input"><input type="checkbox" class="filter-tags dblock" id="tag<?php echo e($tag->id ?? ''); ?>"  name="filters[]" value="<?php echo e($tag->id ?? 0); ?>" <?php if(isset($item->filters) && in_array($tag->id,$item->filters->pluck('id')->toArray())): ?> checked <?php endif; ?>><label for="tag<?php echo e($tag->id ?? ''); ?>"><span></span><?php echo e($tag->tag ?? ''); ?></label></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                            </ul>
                                        </div>
                    ...
                    <div class="steps dnone" id="step3">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-5 tab-con col-md-offset-1 dinb" " for="inputDefault"><?php echo e(trans('main.free_course')); ?></label>
                                <div class="col-md-6 tab-con">
                                    <div class="switch switch-sm switch-primary pull-left">
                                        <input type="hidden" value="1" name="price">
                                        <input type="checkbox" name="price" id="free" value="0" data-plugin-ios-switch <?php if($item->price != null && $item->price == 0): ?> checked="checked" <?php endif; ?> />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-5 tab-con col-md-offset-1 dinb"><?php echo e(trans('main.vendor_postal_sale')); ?></label>
                                <div class="col-md-6 tab-con">
                                    <div class="switch switch-sm switch-primary pull-left" id="post_toggle">
                                        <input type="hidden" value="0" name="post">
                                        <input type="checkbox" name="post" value="1" data-plugin-ios-switch <?php if($item->post == 1): ?> checked="checked" <?php endif; ?> />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label tab-con col-md-5 col-md-offset-1 dinb" for="inputDefault"><?php echo e(trans('main.support')); ?></label>
                                <div class="col-md-6 tab-con">
                                    <div class="switch switch-sm switch-primary pull-left">
                                        <input type="hidden" value="0" name="support">
                                        <input type="checkbox" name="support" value="1" data-plugin-ios-switch <?php if($item->support == 1): ?> checked="checked" <?php endif; ?> />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label tab-con col-md-5 col-md-offset-1 dinb" for="inputDefault"><?php echo e(trans('main.download')); ?></label>
                                <div class="col-md-6 tab-con">
                                    <div class="switch switch-sm switch-primary pull-left">
                                        <input type="hidden" value="0" name="download">
                                        <input type="checkbox" name="download" value="1" data-plugin-ios-switch <?php if($item->download == 1): ?> checked="checked" <?php endif; ?> />
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price" onkeypress="validate(event)" value="<?php echo e($meta['price'] ?? ''); ?>" class="form-control text-center numtostr" <?php if($item->price === 0): ?> disabled <?php endif; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="post_price" onkeypress="validate(event)" value="<?php echo e($meta['post_price'] ?? ''); ?>" class="form-control text-center numtostr" <?php if($item->post != 1): ?> disabled <?php endif; ?>>
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_3" onkeypress="validate(event)" value="<?php echo e($item->price_3 ?? ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_6" onkeypress="validate(event)" value="<?php echo e($item->price_6 ?? ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_9" onkeypress="validate(event)" value="<?php echo e($item->price_9 ?? ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_12" onkeypress="validate(event)" value="<?php echo e($item->price_12 ?? ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="h-15"></div>
                        <div class="alert alert-success"><p><?php echo e(trans('main.prerequisites_desc')); ?></p></div>
                        <a class="btn btn-custom pull-left" data-toggle="modal" href="#modal-pre-course"><span><?php echo e(trans('main.select_prerequisites')); ?></span></a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body no-absolute-content">
                                        ...
                                        <?php echo e(csrf_field()); ?>
                                            ...
                                            <input type="hidden" name="precourse" id="precourse" value="<?php echo e($meta['precourse'] ?? ''); ?>">
                                        </form>
                                        <ul class="pre-course-title-container">
                                            <?php $__currentLoopData = $preCourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li><?php echo e($prec->title ?? ''); ?>&nbsp;(VT-<?php echo e($prec->id ?? 0); ?>)<i class="fa fa-times delete-course" cid="<?php echo e($prec->id ?? 0); ?>"></i></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="cover" placeholder="Prefered :410*730px" dir="ltr" value="<?php echo e($meta['cover'] ?? ''); ?>" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="thumbnail" placeholder="Prefered :155*263px" dir="ltr" value="<?php echo e($meta['thumbnail'] ?? ''); ?>" class="form-control">
                                        <span class="input-group-addon click-for-upload img-icon-s"><span class="formicon mdi mdi-arrow-up-thick"></span></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="video" placeholder="Prefered :1-3 mins"  dir="ltr" value="<?php echo e($meta['video'] ?? ''); ?>" class="form-control">
                                        <span class="input-group-addon click-for-upload img-icon-s"><span class="formicon mdi mdi-arrow-up-thick"></span></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group document-input">
                                        ...
                                        <input type="text" name="document" id="document-addon" dir="ltr" value="<?php echo e($meta['document'] ?? ''); ?>" class="form-control">
                        ...
                        <div class="accordion-off">
                            <ul id="accordion" class="accordion off-filters-li">
                                <li class="open edit-part-section dnone">
                                    <div class="link edit-part-click"><h2><?php echo e(trans('main.edit_part')); ?></h2><i class="mdi mdi-chevron-down"></i></div>
                                    <div class="submenu dblock">
                                        <div class="h-15"></div>
                                        <input type="hidden" id="part-edit-id">
                                        <form action="/user/content_web_coach/part/edit/store/" id="step-5-form-edit-part" method="post" class="form-horizontal">
                                        <?php echo e(csrf_field()); ?>

                                        <input type="hidden" name="content_id" value="<?php echo e($item->id ?? ''); ?>">

                                        <div class="form-group">
                                                <label class="control-label col-md-2 tab-con"><?php echo e(trans('main.date_webinar_coach')); ?></label>
                                                <div class="col-md-3 tab-con">
                                                    <input type="text" class="form-control datetimepicker-input" id="datetimepicker_date_edit" data-toggle="datetimepicker" data-target="#datetimepicker_date_edit" name="date"/>
                                                </div>
                                                <label class="control-label tab-con col-md-1"><?php echo e(trans('main.time_webinar_coach')); ?></label>
                                                <div class="col-md-2 tab-con">
                                                    <input type="text" class="form-control datetimepicker-input" id="datetimepicker_time_edit" data-toggle="datetimepicker" data-target="#datetimepicker_time_edit" name="time"/>
                                                </div>
                                            <label class="control-label tab-con col-md-1"><?php echo e(trans('main.duration')); ?></label>
                                            <div class="col-md-3 tab-con">
                                                <div class="input-group">
                                                    <input type="number" min="0" name="duration" class="form-control text-center" required>
                                                    <span class="input-group-addon img-icon-s"><?php echo e(trans('main.minute')); ?></span>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label tab-con col-md-2"><?php echo e(trans('main.webinar_coach_mail')); ?></label>
                                            <div class="col-md-3 tab-con">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label tab-con col-md-2" for="inputDefault"><?php echo e(trans('main.description')); ?></label>
                                            <div class="col-md-10 tab-con">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label tab-con col-md-2" for="inputDefault"><?php echo e(trans('main.title')); ?></label>
                                            <div class="col-md-8 tab-con">
                                                <input type="text" name="title" class="form-control" required>
                                            </div>
                                            <div class="col-md-2 tab-con">
                                                <button class="btn btn-custom tab-con pull-left" id="edit-part-submit" type="submit"><?php echo e(trans('main.save_changes')); ?></button>
                                            </div>
                                        </div>
                                        </form>
                                        <div class="h-15"></div>
                                ...
                                <li class="open">
                                    <div class="link new-part-click"><h2><?php echo e(trans('main.new_part')); ?></h2><i class="mdi mdi-chevron-down"></i></div>
                                    <div class="submenu dblock">
                                        <div class="h-15"></div>
                                        <form action="/user/content/web_coach/part/store" id="step-5-form-new-part" method="post" class="form-horizontal">
                                        <?php echo e(csrf_field()); ?>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2 tab-con"><?php echo e(trans('main.date_webinar_coach')); ?></label>
                                                <div class="col-md-3 tab-con">
                                                    <input type="text" class="form-control datetimepicker-input" id="datetimepicker_date_create" data-toggle="datetimepicker" data-target="#datetimepicker_date_create" name="date"/>
                                                </div>
                                                <label class="control-label tab-con col-md-1"><?php echo e(trans('main.time_webinar_coach')); ?></label>
                                                <div class="col-md-2 tab-con">
                                                    <input type="text" class="form-control datetimepicker-input" id="datetimepicker_time_create" data-toggle="datetimepicker" data-target="#datetimepicker_time_create" name="time"/>
                                                </div>
                                                <label class="control-label tab-con col-md-1"><?php echo e(trans('main.duration')); ?></label>
                                                <div class="col-md-3 tab-con">
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2 tab-con">
                                                    <button class="btn btn-custom tab-con pull-left" id="new-part" type="submit"><?php echo e(trans('main.save_changes')); ?></button>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="h-15"></div>
                                ...
                                <li>
                                    <div class="link list-part-click"><h2><?php echo e(trans('main.parts')); ?></h2><i class="mdi mdi-chevron-down"></i></div>
                                    <div class="submenu" >
                ...
                <div class="h-10"></div>
                <div class="col-md-12">
					<a href="javascript:void(0);" class="btn btn-custom pull-left tab-con marl-s-10" id="prev-btn"><?php echo e(trans('main.previous')); ?></a>
                    <a href="javascript:void(0);" class="btn btn-custom tab-con pull-left marl-s-10" id="next-btn"><?php echo e(trans('main.next')); ?></a>
                    
                    <?php if($item->mode != 'publish'): ?>
                        <a href="#publish-modal" data-toggle="modal" class="btn btn-custom pull-left tab-con marl-s-10"><?php echo e(trans('main.publish')); ?></a>
                    <?php else: ?>
                        <a href="#re-publish-modal" data-toggle="modal" class="btn btn-custom pull-left tab-con marl-s-10"><?php echo e(trans('main.save_changes')); ?></a>
                    <?php endif; ?>
                    <?php if($item->mode != 'publish'): ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default btn-publish-final"><?php echo e(trans('main.publish')); ?></button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div>
    <div class="modal fade" id="re-publish-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('main.cancel')); ?></button>
                    <button type="button" class="btn btn-default btn-publish-final"><?php echo e(trans('main.yes_sure')); ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-custom pull-left" id="delete-request"><?php echo e(trans('main.yes_sure')); ?></button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $('#new-part').click(function (e) {
            ...
            if(!$('#step-5-form-new-part')[0].checkValidity()){
                ...
                $.post('/user/content/web_coach/part/store', $('#step-5-form-new-part').serialize(), function (data) {
    ...
    <script>
        $('#edit-part-submit').click(function (e) {
            ...
            $.post('/user/content/web_coach/part/edit/store/'+id,$('#step-5-form-edit-part').serialize(),function (data) {
                console.log(data);
            });
            refreshContent();
            $.notify({
...
<?php echo $__env->make(getTemplate().'.user.layout.sendvideolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/web/default/user/content/editweb_coach.blade.php ENDPATH**/ ?>