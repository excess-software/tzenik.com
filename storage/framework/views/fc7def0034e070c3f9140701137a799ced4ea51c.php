            ...
            <div class="formBox level-login" dir="ltr">
                ...
                <div class="box loginBox">
                    ...
                    <form class="form" action="/login" method="post" id="loginForm" style="text-align: left;direction: ltr">
                        ...
                        <button class="btn btn-custom pull-left btn-register-user btn-register-user-r"><span><?php echo e(trans('main.sign_in')); ?></span></button>
                        <div class="h-10"></div>
                        <div class="f_link">
...
<?php echo $__env->make(getTemplate().'.view.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gardoon1/domains/academybusiness.ir/next/resources/views/web/default/auth/login.blade.php ENDPATH**/ ?>