                    ...
                    <div class="steps dnone" id="step3">
                        <form method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input type="text" name="price" onkeypress="validate(event)" value="<?php echo e($meta['price'] or ''); ?>" class="form-control text-center numtostr" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input type="text" name="post_price" onkeypress="validate(event)" value="<?php echo e($meta['post_price'] or ''); ?>" class="form-control text-center numtostr" disabled>
...
<?php echo $__env->make(getTemplate().'.user.layout.sendvideolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/web/default/user/content/new_course.blade.php ENDPATH**/ ?>