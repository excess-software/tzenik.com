                ...
                <div class="col-md-9 col-xs-12 col-sm-8 tab-con left-side">
                    <div class="steps" id="step1">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <input type="hidden" name="type" value="webinar_coaching">
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <select name="type" class="form-control font-s">
                                        ...
                                        <option value="coaching"><?php echo e(trans('main.coaching' )); ?></option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="steps dnone" id="step2">
                        ...
                        <?php echo e(csrf_field()); ?>
                                    ...
                                    <select name="category_id" id="category_id" class="form-control font-s" required>
                                        ...
                                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($menu->parent_id == 0): ?>
                                                <optgroup label="<?php echo e($menu->title or ''); ?>">
                                                    ...
                                                    <?php $__currentLoopData = $menu->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($sub->id or ''); ?>" ><?php echo e($sub->title or ''); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php else: ?>
                                                        <option value="<?php echo e($menu->id or ''); ?>" ><?php echo e($menu->title or ''); ?></option>
                                                    <?php endif; ?>
                                                </optgroup>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="h-15"></div>
                            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-11 col-md-offset-1 filters" id="filter<?php echo e($menu->id or 0); ?>">
                                    <?php $__currentLoopData = $menu->filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-3 col-xs-12">
                                            <h5><?php echo e($filter->filter or ''); ?></h5>
                                            <hr>
                                            <ul class="cat-filters-li pamaz">
                                                <ul class="submenu submenu-s">
                                                    <?php $__currentLoopData = $filter->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="second-input"><input type="checkbox" class="filter-tags dblock" id="tag<?php echo e($tag->id or ''); ?>" name="tags[]" value="<?php echo e($tag->id or 0); ?>"><label for="tag<?php echo e($tag->id or ''); ?>"><span></span><?php echo e($tag->tag or ''); ?></label></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                            </ul>
                                        </div>
                    ...
                    <div class="steps dnone" id="step3">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input type="text" name="price" onkeypress="validate(event)" value="" class="form-control text-center numtostr" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input type="text" name="post_price" onkeypress="validate(event)" value="" class="form-control text-center numtostr" disabled>
                                        <span class="input-group-addon click-for-upload img-icon-s"></span>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make(getTemplate().'.user.layout.sendvideolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/web/default/user/content/new_webinar.blade.php ENDPATH**/ ?>