                ...
                <div class="body">
                    <form method="post" action="/user/ticket/store">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="inputDefault" <?php if(!empty(request()->get('type')) && request()->get('type') == 'become_vendor'): ?> value="<?php echo trans('main.become_vendor_title'); ?>" disabled <?php endif; ?> required>
                        </div>
...
<?php echo $__env->make($user['vendor'] == 1 ? getTemplate() . '.user.layout.supportlayout' : getTemplate() . '.user.layout_user.supportlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gardoon1/domains/academybusiness.ir/next/resources/views/web/default/user/ticket/list.blade.php ENDPATH**/ ?>