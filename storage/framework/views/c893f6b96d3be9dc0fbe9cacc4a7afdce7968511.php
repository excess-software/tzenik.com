                    ...
                    <div class="header back-red headst">
                        ...
                        <div>
                            <button type="button" class="btn btn-primary"
                                id="addMultipleChoice"><?php echo e(trans('main.multiple_choice')); ?></button>
                            <button type="button" class="btn btn-primary"
                                id="descriptiveQuestionBtn"><?php echo e(trans('main.descriptive_question')); ?></button>
                        </div>
                        <br>
                    </div>
                    <div class="body">
                        <?php if(empty($quiz->questions) or count($quiz->questions) < 1): ?> <div class="text-center">
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover" style="margin-left: auto; margin-right: auto;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($loop->iteration .' - '. $question->title); ?></td>
                                        <td><?php echo e((!empty($question->grade) ? $question->grade : 0)); ?></td>
                                        <td><?php echo e($question->type); ?></td>
                                        <td><button data-id="<?php echo e($question->id); ?>" data-type="<?php echo e($question->type); ?>"
                                                class="gray-s btn-transparent btn-question-edit" data-toggle="tooltip"
                                                title="<?php echo e(trans('main.edit_question')); ?>">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            <button data-id="<?php echo e($question->id); ?>"
                                                class="btn-transparent btn-delete-question" data-toggle="tooltip"
                                                title="<?php echo e(trans('main.delete')); ?>"><i class="fa fa-times"></i></button>
                                        </td>
                                    </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="multipleAnswerSubmit"
                    class="btn btn-primary"><?php echo e(trans('main.save')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make(getTemplate() . '.user.vendor.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samuel\Local Sites\proacademydos\app\resources\views/web/default/user/vendor/quizzes/questions.blade.php ENDPATH**/ ?>