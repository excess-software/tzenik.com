                    ...
                    @foreach($comments as $item)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" data-href="/admin/forum/comment/delete/{{{ $item->id }}}" title="Delete" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
