                            ...
                            <!--<div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="image" class="form-control" type="text" name="image" dir="ltr" placeholder="Displays on top menu (80*80px)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="icon" class="form-control" type="text" name="icon" dir="ltr" placeholder="Displays on category page header (80*80px)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="background" class="form-control" type="text" name="background" dir="ltr" placeholder="Displays as category page header background (1920*40px) ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group" style="display: flex">
                                        ...
                                        <input id="app_icon" class="form-control" type="text" name="app_icon" dir="ltr" placeholder="App icon (36 x 36) png only">
