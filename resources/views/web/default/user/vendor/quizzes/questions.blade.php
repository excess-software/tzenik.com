        ...
        <div class="row text-center">
            <div class="col-md-12 tab-con">
                <div class="ucp-section-box">
                    ...
                    <div class="body">
                        @if (empty($quiz->questions) or count($quiz->questions) < 1) <div class="text-center">
                            ...
                            <table class="table table-hover" style="margin-left: auto; margin-right: auto;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ (!empty($question->grade) ? $question->grade : 0) }}</td>
                                        <td>{{ $question->type }}</td>
                                        <td><button data-id="{{ $question->id }}" data-type="{{ $question->type }}"
                                            ...
                                            <button data-id="{{ $question->id }}"
                                                ...
                                                title="{{ trans('main.delete') }}"><i class="fa fa-times"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
