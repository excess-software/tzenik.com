                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <select name="type" class="form-control font-s">
                                        ...
                                        <option value="coaching" @if(isset($item) && $item->type == 'coaching') selected @endif>{{{ trans('main.coaching') }}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <ul id="accordion" class="accordion off-filters-li">
                                <li class="open edit-part-section dnone">
                                    ...
                                    <div class="submenu dblock">
                                        ...
                                        <div class="form-group">
                                                <label class="control-label col-md-2 tab-con">{{{ trans('main.date_webinar_coach') }}}</label>
                                                ...
                                                <label class="control-label tab-con col-md-1">{{{ trans('main.time_webinar_coach') }}}</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label tab-con col-md-2">{{{ trans('main.webinar_coach_mail') }}}</label>
                                            <div class="col-md-3 tab-con">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 tab-con">
                                                <button class="btn btn-custom tab-con pull-left" id="edit-part-submit" type="submit">{{{ trans('main.save_changes') }}}</button>
                                            </div>
                                        </div>
                                        </form>
                                        <div class="h-15"></div>
