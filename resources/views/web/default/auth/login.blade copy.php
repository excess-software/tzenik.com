        ...
        <div class="formBox level-login" dir="ltr">
            ...
            <div class="box loginBox">
                ...
                <form class="form" action="/login" method="post" id="loginForm" style="text-align: left;direction: ltr">
                    ...
                    <div class="f_row">
                        ...
                        <input type="text" name="username" class="input-field validate" autocomplete="new-password"
                            valid-title="Fill out this form" required>
                        <u></u>
                    </div>
                    <div class="f_row last">
                        <label>{{ trans('main.password') }}</label>
                        <input type="password" name="password" class="input-field validate"
                    ...
                    <button
                        class="btn btn-custom pull-left btn-register-user btn-register-user-r"><span>{{ trans('main.sign_in') }}</span></button>
                    <div class="h-10"></div>
                    <div class="f_link">
            ...
            <div class="box registerBox" style="height: 650px">
                ...
                <form class="form" method="post" action="/registerUser" style="text-align: left">
                    ...
                    <div class="f_row">
                        <label>{{ trans('main.realname') }}</label>
                        <input type="name" name="name" class="input-field validate" valid-title="Enter your real name"
                            required>
                        <u></u>
                    </div>
