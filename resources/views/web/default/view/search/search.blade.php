...
@section('content')
    <div class="container">
        <div class="row">
            <div class="cat-search-section">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <h2> {{ !empty($search_title) ? $search_title : 'Search' }}
                        "{{ !empty(request()->get('q')) ? request()->get('q') : '' }}"</h2>
                    <form>
                        {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="panel-description vertical-center">
                                        <div class="curso-destacado-titulo black-text">
                                            <h3><b>{{  $content['title'] }}</b></h3>
                                        </div>
                                        <div class="curso-destacado-contenido">
                                            <div class="col">
                                        ...
                                        <div class="curso-destacado-contenido .bottom-column">
                                            <h4><span class="label label-tag-media-categoria">
                                                    <span class="circle-tag-media-categoria"></span>{{ $content->category->title ? $content->category->title : '' }}
                                                </span>
                                            </h4>
                                        </div>
                                        @endif
                                        <div >
                                            <button class="btn btn-cursos-destacados">
                                                <h4><b>Continuar</b></h4>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <img class="img-responsive" src="{{ !empty($content['metas']['thumbnail']) ? $content['metas']['thumbnail'] : 'https://cdn-a.william-reed.com/var/wrbm_gb_food_pharma/storage/images/1/8/6/0/230681-6-eng-GB/IB3-Limited-SIC-Pharma-April-20142_news_large.jpg' }}"alt="">
                                </div>
                            </div>
                        </div>
                    </div>
