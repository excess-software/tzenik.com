        ...
        <div class="row product-body">
            <div class="container">
                ...
                <div class="col-md-8 col-xs-12">
                    <iframe style="height: 600px; width: 100%;" src="https://zoom.us/wc/{{{ $meeting->zoom_meeting ?? $meeting }}}/join?prefer=0&un=TWluZGF1Z2Fz" sandbox="allow-forms allow-scripts allow-same-origin" allow="microphone; camera" allowfullscreen scrolling="no"></iframe>
                </div>
            </div>
        </div>
    </div>
