        ...
        <div class="product-discount-container">
            <div class="col-md-4 col-xs-12 tab-con">
                <div class="container-s-r">
                    <strong class="red-r">@if($product->discount->last_date - time() > 86400)
                        {{ (floor(($product->discount->last_date - time()) / (60 * 60 * 24))) }} @else 0 @endif</strong>
    ...
    <div class="col-xs-12 col-md-12">
        <div class="product-discount-container">
            <div class="col-md-4 col-xs-12">
                <div class="container-s-r">
                    <strong class="red-r">@if($product->category->discount->last_date - time() > 86400)
                        {{ (floor(($product->category->discount->last_date - time()) / (60 * 60 * 24)))+1 }} @else 0
                        @endif Day</strong>
                    <strong>{{ trans('main.days') }}</strong>
                    <strong>{{ trans('main.special_offer') }}</strong>
                </div>
    ...
    <div class="row product-body">
        <div class="container">
            <div class="col-md-4 col-xs-12 course_details">
                ...
                <div class="product-details-box">
                    <span
                        class="proicon mdi mdi-calendar-month"></span><span>{{ date('d F Y',$product->created_at) }}</span>
                </div>
                <div class="product-details-box">
                ...
                <div class="product-price-box">
                    ...
                    <span
                        id="buy-price">{{ currencySign() }}{{ price($product->id,$product->category_id,$meta['price'])['price']  }}</span>
                    @else
                    ...
                    <form>
                        ...
                        <div class="radio">
                            <input type="radio" id="radio-2" name="buy_mode" data-mode="download"
                                value="{{ price($product->id,$product->category_id,$meta['price'])['price'] }}" checked>
                        ...
                        <div class="radio">
                            <input type="radio" id="radio-1" data-mode="post"
                                value="{{ price($product->id,$product->category_id,$meta['post_price'])['price'] }}"
                                name="buy_mode">
                        ...
                        <a class="btn btn-orange product-btn-buy sbox3" id="buy-btn" data-toggle="modal"
                            data-target="#buyModal" href="">{{ trans('main.pay') }}</a>
                        @endif
                        @else
                        @if(!empty($product->price) and $product->price != 0)
                    ...
                    <div class="modal-content">
                            ...
                            <div id="postAddress">
                                <form method="post" class="form-horizontal" action="/user/profile/meta/store">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="control-label col-md-1 tab-con">{{ trans('main.province') }}</label>
                                        <div class="col-md-5 tab-con">
                                            <input type="text" class="form-control" name="state"
                                                value="{!! $userMeta['state'] ?? '' !!}" />
                                        </div>
                                        <label class="control-label col-md-1 tab-con">{{ trans('main.city') }}</label>
                                        <div class="col-md-5 tab-con">
                                            <input type="text" name="city" value="{{ $userMeta['city'] ?? '' }}"
                                                class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="control-label col-md-1 tab-con">{{ trans('main.address') }}</label>
                                        <div class="col-md-5 tab-con">
                                            <textarea name="address" rows="4"
                                                class="form-control">{{ $userMeta['address'] ?? '' }}</textarea>
                                        </div>
                                        <label
                                            class="control-label col-md-1 tab-con">{{ trans('main.zip_code') }}</label>
                                        <div class="col-md-5 tab-con">
                                            <input type="text" name="postalcode"
                                                value="{{ $userMeta['postalcode'] ?? '' }}"
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="javascript:void(0);" class="btn btn-custom pull-right" id="btn-address"
                                onclick="$('#postAddress').slideToggle(200);">{{ trans('main.change_address') }}</a>
                ...
                <div class="row">
                    ...
                    <div class="course_details">
                        ...
                        <div class="product-user-box-footer">
                            <a href="{!! $live->join_url ?? '' !!}"
                                target="_blank">{{ trans('main.enter_live_class') }}</a>
                        </div>
                        <div class="h-25"></div>
                    </div>
                    <div class="h-10"></div>
                    ...
                    <div class="course_details">
                        <div class="product-user-box">
                            ...
                            <img class="img-box"
                                src="{{ !empty($userMetas['avatar']) ? $userMetas['avatar'] : get_option('default_user_avatar','') }}"
                            ...
                            <div class="text-center">
                                ...
                                @if (!empty($rate['image']))
                                <img class="img-icon img-icon-s" src="{{ $rate['image'] }}"
                ...
                <div class="user-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="#tab1" role="tab"
                                data-toggle="tab">{{ trans('main.course_content') }}</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <ul class="part-ul">
                                    ...
                                    <div class="part-links">
                                        ...
                                        <div class="col-md-1 col-xs-2 tab-con">
                                            <span class="download-part"
                                                data-href="/video/download/{{ $part['id'] }}"><span
                                ...
                                <li class="document">
                                    ...
                                    <div class="col-md-1 text-center">
                                        <span class="download-part" data-href="{{ $meta['document'] }}"><span
                                                class="mdi mdi-arrow-down-bold"></span></span>
                                    </div>
                                </li>
                                @endif
                        ...
                        <div class="tab-pane fade in tab-body" id="tab3">
                            ...
                            <div class="col-md-4 col-xs-12 tab-con">
                                <a href="/product/{{ $pc->id }}" title="{{ $pc->title }}"
                                    ...
                                    <div class="footer">
                                        ...
                                        <label
                                            class="pull-left">{{ currencySign() }}{{ price($pc->id,$pc->category_id,$pmeta['price'])['price'] }}</label>
                                    </div>
                                </a>
                            </div>
                            @endforeach
                        ...
                        <div class="tab-pane fade" id="tab4">
                            ...
                            <ul class="part-ul">
                                ...
                                <li class="row">
                                    ...
                                    <div class="col-md-2 text-center hidden-xs tab-con">
                                        <span
                                            style="color: {{ $quiz->result_status == 'pass' ? 'green' : ($quiz->result_status == 'fail' ? 'red' : 'black') }}">{{ ( isset($quiz->user_grade)) ? $quiz->user_grade : 'No grade' }}</span>
                                    </div>

                                    <div class="col-md-2 text-center hidden-xs tab-con">
                                        <a href="{{ ($quiz->can_try) ? '/user/quizzes/'. $quiz->id .'/start' : ''}}"
                                            {{ (!$quiz->can_try) ? 'disabled="disabled"' : '' }}
                        ...
                        <div class="tab-pane fade" id="tab5">
                            @if (!empty($product->quizzes) and !$product->quizzes->isEmpty() and $hasCertificate and
                            ...
                            <ul class="part-ul">
                                ...
                                <li class="row">
                                    ...
                                    <div class="col-md-2 text-center hidden-xs tab-con">
                                        <a href="/user/certificates/{{ $quiz->result->id }}/download"
                                            class="btn btn-success">{{ trans('main.download_certificate') }}</a>
                                    </div>
                                </li>
                                @endif
                                @endforeach
                            ...
                            <table class="table table-hover table-bordered" style="margin-bottom: 0;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{!! $meeting->date ?? '' !!} {!! $meeting->time ?? ''
                                            !!}</td>
                                        <td class="text-center">{!! $meeting->duration ?? '' !!}&nbsp;{!!
                                            trans('admin.minutes') !!}</td>
                ...
                <div class="user-tabs">
                    <ul class="nav nav-tabs back-blue" role="tablist">
                        <li class="active"><a href="#vtab1" role="tab"
                                data-toggle="tab">{{ trans('main.similar_courses') }}</a></li>
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane fade in tab-body" id="vtab1">
                            ...
                            <div class="col-md-4 col-xs-12 tab-con">
                                <a href="/product/{{ $rel->id }}" title="{{ $rel->title }}"
                                    class="content-box content-box-r">
                                    ...
                                    <div class="footer">
                                        <span class="boxicon mdi mdi-wallet pull-left"></span>
                                        <label
                                            class="pull-left">{{ currencySign() }}{{ price($rel->id,$rel->category_id,$rmeta['price'])['price'] }}</label>
                                    </div>
                                </a>
                            </div>
                            @endforeach
                        ...
                        <div class="tab-pane fade tab-body" id="vtab2">
                            ...
                            <div class="col-md-4 col-xs-12 tab-con">
                                <a href="/product/{{ $puc->id }}" title="{{ $puc->title }}"
                                    class="content-box content-box-r">
                                    ...
                                    <div class="footer">
                                        <span class="boxicon mdi mdi-wallet pull-left"></span>
                                        <label
                                            class="pull-left">{{ currencySign() }}{{ price($puc->id,$puc->category_id,$umeta['price'])['price'] }}</label>
                                    </div>
                                </a>
                            </div>
                            @endif
                ...
                <div class="user-tabs">
                    <ul class="nav nav-tabs back-green" role="tablist">
                        <li class="active"><a href="#ctab1" role="tab"
                                data-toggle="tab">{{ trans('main.comments') }}&nbsp;({{ $product->comments_count }})</a>
                        </li>
                        @if($product->support == 1)
                        @if(!empty($product->supports->sum('rate')) and $product->supports->sum('rate') > 0 and
                        !empty($product->supports) and count($product->supports) > 0)
                        <li><a href="#ctab2" role="tab" data-toggle="tab">Support &nbsp;(Rating:
                                {{ $product->support_rate }})</a></li>
                        @else
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane fade in blog-comment-section body-target-s" id="ctab1">
                            ...
                            <ul class="comment-box support-list1">
                                ...
                                <li class="user-metas">
                                    ...
                                    <a href="/profile/{{ $comment->user_id }}">{{ $comment->name }}
                                        @if($comment->user->buys_count > 0) <b
                                            class="green-s">({{ trans('main.student') }})</b>
                                        @elseif($comment->user->contents_count > 0) <b
                                            class="blue-s">({{ trans('main.vendor') }})</b> @else <b
                                            class="gray-s">({{ trans('main.user') }})</b> @endif</a>
                                    <label class="pull-left">{{ date('d F Y | H:i',$comment->created_at) }}</label>
                                    <span>{!! $comment->comment !!}</span>
                                    @if($buy or (isset($user) and $product->user_id == $user['id']))<span><a
                                            href="javascript:void(0);" answer-id="{{ $comment->id }}"
                                            answer-title="{{ $comment->name }}"
                                            class="pull-left answer-btn">{{ trans('main.reply') }}</a> </span>@endif
                                </li>
                                ...
                                <ul class="col-md-11 col-md-offset-1 answer-comment">
                                    ...
                                    <li>
                                        <img src="{{ !empty($cuserMeta['avatar']) ? $cuserMeta['avatar'] : '/assets/default/images/user.png' }}"
                                            alt="" />
                                        <a href="/profile/{{ $child->user_id }}">{{ $child->name }}
                                            @if($child->user->buys_count > 0) <b
                                                class="green-s">({{ trans('main.customer') }})</b>
                                            @elseif($child->user->contents_count > 0) <b
                                                class="blue-s">({{ trans('main.vendor') }})</b> @else <b
                                                class="gray-s">({{ trans('main.user') }})</b> @endif</a>
                                ...
                                <span class="btn btn-custom pull-left"
                                    id="loadMore1">{{ trans('main.load_more') }}</span>
                                @endif
                            </ul>
                        </div>
                        @if($product->support == 1)
                        <div class="tab-pane fade blog-comment-section body-target-s" id="ctab2">
                            ...
                            <div class="col-xs-12 text-center support-lock">
                                ...
                                <a
                                    href="/user/ticket/support?openid={{ $product->id }}">{{ trans('main.panel_support') }}</a>
                            ...
                            <ul class="comment-box support-list">
                                ...
                                <li class="user-metas">
                                    <img src="{{ !empty($senderMeta['avatar']) ? $senderMeta['avatar'] : '/assets/default/images/user.png' }}"
                                        alt="" />
                                ...
                                <li class="user-metas">
                                    ...
                                    <label class="pull-left text-center">
                                        {{ date('d F Y | H:i',$support->created_at) }}
                                        <br>
                                        <div class="userraty urating" data-score="{{ $support->rate }}"
                                            data-id="{{ $support->id }}"></div>
                                    </label>
                                    <span>{!! $support->comment !!}</span>
                                </li>
                                @endif
                                ...
                                <span class="btn btn-custom pull-left"
                                    id="loadMore">{{ trans('main.load_more') }}</span>
                                @endif
                            </ul>
                        </div>
                        @endif
...
<div class="modal fade" id="cardModal" tabindex="-1" role="dialog" aria-labelledby="cardModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/product/{{ $product->id }}"><button type="button" class="btn btn-secondary">Close</button></a>
            </div>
        </div>
    </div>
</div>
                ...
                if (data == 0) {
                    ...
                    if (data.type == 'gift')
                        $('#gift-card-result').html(
                            '<b class="green-s"> Congratulations! {!! currencySign() !!}' + data.off +
