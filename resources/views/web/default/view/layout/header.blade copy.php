        ...
        $(document).ready(function () {
            ...
            $('.msg_send_btn').click(function () {
                ...
                if ($('.write_msg').val() != '') {
                    ...
                    socket.emit('sendMessage', $('.write_msg').val(), '{{ $user['
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <div class="topnav">
        <div class="logo-navbar">
            <img src="{{ get_option('site_logo') }}" alt="{{ get_option('site_title') }}" class="logo" />
            <img src="{{ get_option('site_logo_type') }}" alt="{{ get_option('site_title') }}" class="logo" />
        </div>
            <!-- <form action="/search">
                {{ csrf_field() }}
                <input type="text" name="q" class="provider-json" placeholder="Search..." />
        ...
        <div class="options-navbar">
            <ul class="navbar-items">
                <li><a class="navbar-accesibilidad">Men&uacute; de accesibilidad</a></li>
                <li><a class="navbar-perfil">Perfil</a></li>
            </ul> 
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="row middle-header">
                ...
                <div class="col-md-1 col-xs-12 text-center tab-con">
                    @if(isset($user))
                    <div class="row">
